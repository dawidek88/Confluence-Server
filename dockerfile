...
ARG DWONDLOAD_JDBC=https://jdbc.postgresql.org/download/postgresql-9.4-1202.jdbc41.jar
...
&& curl -Ls ${DOWNLOAD_JDBC} -o "${CONFLUENCE_INSTALL_DIR}/confluence/WEB-INF/lib" 
